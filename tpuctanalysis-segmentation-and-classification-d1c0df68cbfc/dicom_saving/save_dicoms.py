...
sys.path.insert(0,"/Users/Parth Gautam/Desktop/CT_Project/tpuctanalysis-segmentation-and-classification-d1c0df68cbfc")
...
from dicom_data_working.convert_dicoms import normalize_slices_for_images
...
def save_dicom_data(dicom_file_data, file_path_to_save, with_original_meta=True):
    ...
    """
    pydicom.write_file(file_path_to_save,
                     dicom_file_data,
                     write_like_original=with_original_meta)

folder_path="/Users/Parth Gautam/Desktop/Python Scripts/Tomsk/clinical_records_20180410_165453_268/268/CT/20130424"
folder_path_to_save="/Users/Parth Gautam/Desktop/Python Scripts/Tomsk/clinical_records_20180410_165453_268/268/CT/Saved"
