...
sys.path.insert(0, "/Users/Parth Gautam/Desktop/CT_Project-master/tpuctanalysis-segmentation-and-classification-d1c0df68cbfc")
...
def read_all_dicom_data(dicom_folder_path, dicom_file_names):
    ...
    """
    dicom_data_list = [pydicom.read_file(os.path.join(dicom_folder_path, dfn))
